...
1. add in the `gtsummary` R package
2. add examples with the `rtables` R package 
3. add examples of scatterplots & histograms of scores - google is your friend here
