---
title: "Meaningful Change via eCDF and ePDF"
...
Output the table to include in your report:
```{r cap_out, eval = T}
library(R2Word)
...
#dat$anchor.groups <- gsub(pattern = 'Deteriorated_2+', replacement = paste0("Deteriorated \u2265 2"), x = dat$anchor.groups )
